...
def drawALL(img, buttonList):
    ...
    for button in buttonList:
        ...
        cv2.rectangle(img, tuple(button.pos), tup,  color,cv2.FILLED, 1)
    ...
    if lmList:
        for button in buttonList:
            ...
            if x < lmList[8][0] < x+w and y<lmList[8][1] < y+h:
                cv2.rectangle(img, (x-5,y-5), (x + w+5, y + h+5), (175, 0, 175), cv2.FILLED,1)
                cv2.putText(img, button.text, (x + 20, y + 65), cv2.FONT_HERSHEY_PLAIN, 4, (255, 255, 255), 4)
                ...
                if l <30:
                    ...
                    cv2.rectangle(img, tuple(button.pos), (x + w, y + h), (0, 255, 0), cv2.FILLED,1)
                    cv2.putText(img, button.text, (x + 20, y + 65), cv2.FONT_HERSHEY_PLAIN, 4, (255, 255, 255), 4)
                    finalText += button.text
                    sleep(0.15)

    cv2.rectangle(img, (50,350), (700,450), (175, 0, 175), cv2.FILLED,1)
